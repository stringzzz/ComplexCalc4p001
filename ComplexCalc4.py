...
in_file = open("calcMemory.txt", 'r')
if in_file.readable():
    file_list = in_file.readlines()
    gv.skin = file_list[0].strip()
...
def get_save():
    out_file = open("calcMemory.txt", 'w')
...
root.title("ComplexCalc 4.001: by stringzzz, Ghostwarez Co. 2023")
bg = PhotoImage(file='Calc4_bg1.png')
label_one = Label(root, image=bg)
label_one.place(x=0, y=0)
output_display = Label(text = "", height = 8, width = 50, font = ("Arial", 12), foreground = "black", background = "#9090FF")
root.bind("<KeyPress>", keydown) #Key press event

#Buttons, call to functions when pressed
button_9 = Button(text = "9", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(9))
button_8 = Button(text = "8", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(8))
button_7 = Button(text = "7", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(7))
button_6 = Button(text = "6", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(6))
button_5 = Button(text = "5", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(5))
button_4 = Button(text = "4", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(4))
button_3 = Button(text = "3", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(3))
button_2 = Button(text = "2", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(2))
button_1 = Button(text = "1", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(1))
button_0 = Button(text = "0", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_num(0))
button_dot = Button(text = ".", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = get_dot)
button_i = Button(text = "i", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = get_i)
button_mod = Button(text = "Mod", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_func("Mod"))
button_arg = Button(text = "Arg", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_func("Arg"))
button_e = Button(text = "e^", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_func("e^"))
button_log = Button(text = "Log", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_func("Log"))
button_sin = Button(text = "Sin", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_func("Sin"))
button_cos = Button(text = "Cos", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_func("Cos"))
button_tan = Button(text = "Tan", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_func("Tan"))
button_pow = Button(text = "Pow", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = get_pow)
button_add = Button(text = "+", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_operator("+"))
button_sub = Button(text = "-", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_operator("-"))
button_times = Button(text = "*", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_operator("*"))
button_divide = Button(text = "/", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_operator("/"))

button_w = Button(text = "w", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: use_var("w"))
button_x = Button(text = "x", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: use_var("x"))
button_y = Button(text = "y", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: use_var("y"))
button_z = Button(text = "z", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: use_var("z"))
button_var = Button(text = "Var", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = get_var)
button_save = Button(text = "Save", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = get_save)

button_clear = Button(text = "Clear", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = get_clear)
button_inverse = Button(text = "Inv", width = 4, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = lambda: get_func("Inv"))
button_equals = Button(text = "=", width = 32, height = 2, font = ("Arial", 17), foreground = "black", background = "#3030FF", command = get_equals)
